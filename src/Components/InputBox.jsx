...
const inputBox = () => {
  ...
  return (
    <>
      <div style={{ paddingLeft: '27px' }} className='mb-4'>
        <h1 className='mb-5 text-white text-center'>Convert {from} To {to}</h1>
        <form action="" className="text-center">
          ...
          <button
            ...
            onClick={swap}
            style={{ height: '50px', background: 'white', color: 'black', border: '0', margin: '8px' }}
          >
            Swap
            <i className="bi bi-arrow-repeat mx-2" style={{ fontSize: '20px' }}></i>
          </button>
